...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-white rounded-xl p-5 border border-gray-100 shadow-sm flex items-center justify-between">
            ...
            <i class="fas fa-users text-green-300 text-3xl"></i>
        </div>
    </div>
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center font-semibold text-gray-700">Users</th>
                        <th class="px-6 py-3 text-center font-semibold text-gray-700">Permissions</th>
                ...
                <tbody id="rolesTableBody">
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-400">Loading...</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div id="noResults" class="hidden text-center text-gray-400 py-10">No roles found</div>
</div>
